...
rating_request_template = text(
    hbold(
        "📊 Оцініть, будь ласка, тренування на яке Ви реєструвались, якщо відвідували.\n"
    ),
    hbold("🏷 Тренування: ") + hitalic("{title}"),
    hbold("⏰ Дата: ") + "{date}\n",
...
rating_confirmation_template = text(
    ...
    "🏷 " + hbold("Назва: ") + hitalic("{title}"),
    "💫 " + hbold("Оцінка: ") + "{rating}\n",
    hitalic("Дякуємо за оцінювання!\n"),
    "💬 "
    + hitalic("Ваш відгук допомагає нам покращувати якість тренувань."),
    sep="\n",
)
