...
registration_required_template = text(
    "Ви ще не зареєстровані в клубі.\n",
   "Щоб продовжити, будь ласка:",
    "1⃣ Перейдіть в приватний чат з ботом",
    "2⃣ Використайте команду /start\n",
    "👉 Після реєстрації ви зможете користуватись усіма функціями клубу!",
    sep="\n"
)